...
export default function HomeScreen(){
  ...
  const FloatingAssistant=({insideMt=false}:{insideMt?:boolean})=>{
    ...
    return <Animated.View style={[s.floatPanel,insideMt?s.floatPanelMt:null,desktop&&Platform.OS==="web"?({zoom:assistScale} as any):null,{transform:panelPosition.getTranslateTransform()}]}>
