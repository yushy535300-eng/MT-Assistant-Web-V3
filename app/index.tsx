      ...
      <View style={[s.selectorWrap,!desktop?s.selectorWrapMobile:null]}>
        <Pressable style={[s.selector,!desktop?s.selectorMobile:null]} onPress={()=>{
          ...
          <View style={s.selectorLeft}>
            ...
            <View style={s.selectorConfidence}>
              <View style={[s.signalDotSmall,{backgroundColor:assistConfidenceState.color,shadowColor:assistConfidenceState.color}]}/>
              <Text numberOfLines={1} style={[s.confidenceText,{color:assistConfidenceState.color,textShadowColor:assistConfidenceState.color}]}>{assistConfidenceState.label}</Text>
            </View>
          </View>
