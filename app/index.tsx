      ...
      <View style={s.selectorWrap}>
        ...
        {roomDropdownOpen?<View style={s.roomDropdown}>
          <ScrollView
            ...
            style={[s.roomDropdownScroll,Platform.OS==="web"?({overflowY:"auto",overscrollBehavior:"contain",touchAction:"pan-y"} as any):null]}
