...
function ThreadsSignature(){return <View style={s.threadsSignature}><FontAwesome6 name="threads" size={13} color="#F2F8FC"/><Text style={s.threadsId}>@uss0857</Text></View>}
...
export default function HomeScreen(){
  ...
  const FloatingAssistant=({insideMt=false}:{insideMt?:boolean})=>{
    ...
    const page1=<View {...pageSwipe.panHandlers} style={[s.assistPage,!desktop?s.assistPageMobile:null]}>
      ...
      <View style={[s.aiBox,!desktop?s.aiBoxMobile:null]}><Text style={s.aiTitle}>AI分析</Text><Text style={s.aiText}>{analysisText(assistTable)}</Text></View>
    </View>;
...
const s=StyleSheet.create({
  ...
  topbar:{minHeight:58,paddingHorizontal:14,flexDirection:"row",alignItems:"center",justifyContent:"space-between",borderBottomWidth:1,borderBottomColor:"#31536B",backgroundColor:"#07111C"},brandIcon:{width:34,height:34,borderRadius:8,borderWidth:1,borderColor:"#315D79",alignItems:"center",justifyContent:"center",backgroundColor:"#071521"},brandTitleRow:{flexDirection:"row",alignItems:"center",gap:8},kicker:{color:"#7890A3",fontSize:8,letterSpacing:1.1},title:{color:"#F2F6F9",fontSize:16,fontWeight:"800"},
  ...
  floatPanelMobile:{right:58,bottom:18,borderRadius:8},floatHeaderMobile:{height:32,paddingHorizontal:7},selectorWrapMobile:{marginHorizontal:5,marginTop:5},selectorMobile:{height:32,paddingHorizontal:8},assistPageMobile:{padding:5,minHeight:118},decisionRowMobile:{gap:4},decisionBoxMobile:{minHeight:54,padding:5},todayPnlBoxMobile:{marginTop:4,paddingHorizontal:7,paddingVertical:4},aiBoxMobile:{marginTop:4,padding:5},pageDotsMobile:{height:15},
