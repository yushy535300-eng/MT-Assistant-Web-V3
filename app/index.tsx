...
export default function HomeScreen(){
  ...
  const orbResponder=useMemo(()=>PanResponder.create({
    ...
    onMoveShouldSetPanResponderCapture:(_,g)=>Math.abs(g.dx)>=1||Math.abs(g.dy)>=1,
