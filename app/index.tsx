    ...
    <View style={s.loginScreen}>{Platform.OS==="web"?createElement("video" as any,{ref:(node:any)=>{webVideoRef.current=node},src:"/poker.mp4",autoPlay:true,muted:true,defaultMuted:true,playsInline:true,preload:"auto",controls:false,disablePictureInPicture:true,style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",pointerEvents:"none"},onLoadedData:(e:any)=>{const v=e.currentTarget;v.muted=true;v.defaultMuted=true;void v.play?.().catch?.(()=>undefined)},onCanPlay:(e:any)=>{const v=e.currentTarget;v.muted=true;void v.play?.().catch?.(()=>undefined)},onEnded:(e:any)=>{const v=e.currentTarget;playCount.current+=1;if(playCount.current<2){v.currentTime=0;void v.play?.().catch?.(()=>undefined)}else{v.pause();try{v.currentTime=Math.max(0,(v.duration||0)-0.05)}catch{}}}}):<VideoView player={player} style={s.loginVideo} contentFit="cover" nativeControls={false}/>}<View style={s.loginShade}/><View style={s.loginPanel}>
      ...
      <View style={s.loginHero}>
        <View style={s.loginBrand}>
          ...
          <View style={s.loginBrandCopy}><Text style={s.loginKicker}>REAL-TIME CONTROL ROOM</Text><Text style={s.loginTitle}>即時多桌牌路</Text><Text style={s.loginSub}>安全登入後進入牌路控制台</Text></View>
        </View>
        ...
        <View style={s.threadsCard}>
          ...
          <Pressable style={({pressed}:any)=>[s.threadsFollow,pressed&&s.threadsFollowPressed]} onPress={openThreads}><MaterialIcons name="add" size={13} color="#EAF8FF"/><Text style={s.threadsFollowText}>FOLLOW</Text></Pressable>
        </View>
      </View>
...
const s=StyleSheet.create({
  ...
  loginScreen:{flex:1,backgroundColor:"#020A12",alignItems:"center",justifyContent:"center",padding:18,overflow:"hidden"},loginVideo:{...StyleSheet.absoluteFillObject},loginShade:{...StyleSheet.absoluteFillObject,backgroundColor:"rgba(2,10,18,.46)"},loginPanel:{width:"100%",maxWidth:480,backgroundColor:"rgba(7,31,44,.76)",borderWidth:1,borderColor:"rgba(82,151,177,.62)",borderRadius:18,padding:22,shadowColor:"#000",shadowOpacity:.4,shadowRadius:20,elevation:14},loginTopline:{flexDirection:"row",justifyContent:"space-between",alignItems:"center",marginBottom:26},loginTopText:{color:"#A9BED0",fontSize:9,letterSpacing:1.8,fontWeight:"700"},loginSafe:{color:"#39E0B0",fontSize:9,fontWeight:"800"},loginHero:{flexDirection:"row",alignItems:"stretch",width:"100%",marginBottom:22,minHeight:104},loginBrand:{flex:1.55,flexDirection:"row",alignItems:"center",justifyContent:"flex-start",gap:12,paddingLeft:2,paddingRight:14},loginBrandCopy:{flexShrink:1},loginIcon:{width:46,height:46,borderRadius:12,borderWidth:1,borderColor:"#D5A82F",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(245,198,74,.08)"},loginKicker:{color:"#8DB4CE",fontSize:8,letterSpacing:1.35,fontWeight:"700"},loginTitle:{color:"#F5F8FA",fontSize:22,fontWeight:"900",marginTop:4},loginSub:{color:"#91A7B8",fontSize:9.5,marginTop:3},loginHeroDivider:{width:1,marginVertical:7,backgroundColor:"rgba(111,169,197,.25)"},threadsCard:{flex:1,minWidth:128,marginLeft:14,paddingHorizontal:12,paddingVertical:10,borderRadius:13,borderWidth:1,borderColor:"rgba(108,177,205,.34)",backgroundColor:"rgba(3,18,29,.30)",justifyContent:"center"},threadsHead:{flexDirection:"row",alignItems:"center",gap:6},threadsLogo:{width:25,height:25,borderRadius:8,borderWidth:1,borderColor:"rgba(224,243,255,.48)",backgroundColor:"rgba(255,255,255,.06)",alignItems:"center",justifyContent:"center"},threadsLogoText:{color:"#F5FBFF",fontSize:18,fontWeight:"900",lineHeight:21},threadsLabel:{color:"#A9C4D6",fontSize:7.5,fontWeight:"900",letterSpacing:1.25},threadsName:{color:"#F5F9FC",fontSize:13,fontWeight:"900",marginTop:7},threadsAccount:{color:"#56D7D0",fontSize:9,fontWeight:"800",marginTop:1},threadsFollow:{height:27,marginTop:8,borderRadius:7,borderWidth:1,borderColor:"rgba(78,192,235,.58)",backgroundColor:"rgba(23,128,180,.20)",flexDirection:"row",alignItems:"center",justifyContent:"center",gap:3},threadsFollowPressed:{opacity:.72,transform:[{scale:.985}]},threadsFollowText:{color:"#EAF8FF",fontSize:8,fontWeight:"900",letterSpacing:1.05},loginDivider:{height:1,backgroundColor:"rgba(109,157,184,.32)",marginBottom:20},loginHint:{color:"#A7B8C5",fontSize:11,marginBottom:18},loginLabel:{color:"#B9C8D3",fontSize:11,fontWeight:"700",marginBottom:6},loginInput:{height:48,backgroundColor:"rgba(2,17,28,.68)",borderRadius:8,borderWidth:1,borderColor:"#385B70",color:"#fff",paddingHorizontal:14,fontSize:14,marginBottom:14},passwordWrap:{height:48,backgroundColor:"rgba(2,17,28,.68)",borderRadius:8,borderWidth:1,borderColor:"#385B70",flexDirection:"row",alignItems:"center",marginBottom:16},passwordInput:{flex:1,height:"100%",color:"#fff",paddingHorizontal:14,fontSize:14},eyeBtn:{width:46,height:"100%",alignItems:"center",justifyContent:"center"},loginBtn:{height:50,backgroundColor:"#168CEB",borderRadius:8,alignItems:"center",justifyContent:"center",flexDirection:"row",gap:8},loginBtnText:{color:"#fff",fontSize:14,fontWeight:"900"},error:{color:"#FF959C",fontSize:11,textAlign:"center",marginTop:10},loginFoot:{color:"#71899A",fontSize:9,textAlign:"center",marginTop:18},loginHelp:{color:"#42B9F5",fontSize:10,fontWeight:"800",textAlign:"center",marginTop:10},
