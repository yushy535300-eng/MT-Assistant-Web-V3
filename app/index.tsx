...
// 珠盤 UI 尺寸鎖定：整區 73.62×87.66px；6×6；單格 12.27×14.61px。
...
export default function HomeScreen(){
  ...
  const orbResponder=useMemo(()=>PanResponder.create({
    ...
    onPanResponderMove:(_,g)=>{orbPosition.setValue({x:g.dx,y:g.dy})},
    onPanResponderRelease:(_,g)=>{
      ...
      if(Math.hypot(g.dx,g.dy)<5)setFloatingOpen(v=>!v);
    },
  ...
  const panelDrag=useMemo(()=>PanResponder.create({
    ...
    onPanResponderMove:(_,g)=>{panelPosition.setValue({x:g.dx,y:g.dy})},
    onPanResponderRelease:()=>{
      panelPosition.flattenOffset();
      const panelWidth=Math.min(width-20,panelBaseWidth*(desktop?assistScale:1));
  ...
  const FloatingAssistant=({insideMt=false}:{insideMt?:boolean})=>{
    ...
    return <Animated.View style={[s.floatPanel,{width:panelBaseWidth,maxWidth:width-20},insideMt?s.floatPanelMt:null,desktop&&Platform.OS==="web"?({zoom:assistScale} as any):null,{transform:panelPosition.getTranslateTransform()}]}>
      ...
      <View style={s.selectorWrap}>
        <Pressable style={s.selector} onPress={()=>setRoomDropdownOpen(v=>!v)}>
...
const s=StyleSheet.create({
  ...
  tableBody:{flexDirection:"row",height:150,backgroundColor:"#fff",overflow:"hidden"},tableBodyDesktop:{height:138},tableBodyMobile:{height:124},dealer:{width:112,backgroundColor:"#F2F0EC",padding:4,justifyContent:"flex-end"},dealerDesktop:{width:"21.88%"},dealerMobile:{width:"21.88%",minWidth:68,maxWidth:92},photo:{position:"absolute",top:3,left:3,right:3,height:112,backgroundColor:"#DCE2E6",alignItems:"center",justifyContent:"center",overflow:"hidden"},photoDesktop:{height:"82%"},photoMobile:{height:"80%"},photoImage:{width:"100%",height:"100%",resizeMode:"cover"},crown:{fontSize:30,color:"#C5A24C"},dealerName:{color:"#fff",backgroundColor:"#873B96",alignSelf:"flex-start",paddingHorizontal:4,paddingVertical:1,fontSize:8,fontWeight:"800"},meta:{color:"#526371",fontSize:6.5,marginTop:1},
  roadArea:{flex:1,flexDirection:"row",backgroundColor:"#fff",minWidth:0,overflow:"hidden"},roadAreaDesktop:{},beadPane:{width:73.62,height:87.66,flexShrink:0,borderRightWidth:1,borderColor:"#C9D2D9",overflow:"hidden",justifyContent:"flex-start",alignSelf:"flex-start",backgroundColor:"#FFFFFF"},beadPaneDesktop:{width:73.62,height:87.66},beadGrid:{width:73.62,height:87.66,flexDirection:"row",flexWrap:"wrap",alignContent:"flex-start",backgroundColor:"#FFFFFF"},beadCell:{width:12.27,height:14.61,flexGrow:0,flexShrink:0,borderRightWidth:1,borderBottomWidth:1,borderColor:"#D9DEE3",alignItems:"center",justifyContent:"center",backgroundColor:"#FFFFFF"},beadCellDesktop:{width:12.27,height:14.61},beadDot:{width:"82%",aspectRatio:1,borderRadius:999,borderWidth:1,alignItems:"center",justifyContent:"center",shadowColor:"#000",shadowOpacity:.10,shadowRadius:1,elevation:1},beadDotDesktop:{width:"80%"},beadDotText:{color:"#FFFFFF",fontSize:8,fontWeight:"900",lineHeight:10,textAlign:"center"},beadDotTextDesktop:{fontSize:8,lineHeight:10},roadStack:{flex:1,minWidth:0,height:"100%"},bigGrid:{width:"100%",height:"58%",flexDirection:"row",flexWrap:"wrap",alignContent:"stretch"},bigGridDesktop:{},bigCell:{width:"6.6666667%",height:"16.6666667%",borderRightWidth:1,borderBottomWidth:1,borderColor:"#DDE4E9",alignItems:"center",justifyContent:"center"},bigCellDesktop:{},bigMark:{width:"68%",aspectRatio:1,borderRadius:999,borderWidth:1.4,backgroundColor:"transparent",alignItems:"center",justifyContent:"center"},bigMarkDesktop:{width:"66%",borderWidth:1.1},tieNumber:{color:"#20B66B",fontSize:7,fontWeight:"900",lineHeight:8},tieNumberDesktop:{fontSize:6,lineHeight:7},lowerArea:{width:"100%",height:"42%",flexDirection:"row",borderTopWidth:1,borderTopColor:"#CCD6DE"},lowerAreaDesktop:{},lowerPane:{width:"33.333333%",height:"100%",flexDirection:"row",flexWrap:"wrap",alignContent:"stretch",borderRightWidth:1,borderRightColor:"#DDE4E9"},lowerCell:{width:"10%",height:"16.6666667%",alignItems:"center",justifyContent:"center",borderRightWidth:.5,borderBottomWidth:.5,borderColor:"#E4E8EB"},lowerCellDesktop:{},lowerHollow:{width:7,height:7,borderRadius:999,borderWidth:1.8,backgroundColor:"transparent"},lowerSolid:{width:7,height:7,borderRadius:999},lowerSlash:{width:7,height:2,borderRadius:2,transform:[{rotate:"-45deg"}]},
